...
export async function sendTelegramDirect(
  ...
  // EMAIL_TESTING blocks Telegram unless explicitly opted in.
  if (isEmailTestingMode() && !isEmailTestingTelegramAllowed()) {
    console.info("[Telegram] skipped (EMAIL_TESTING=true)");
    return false;
  }
