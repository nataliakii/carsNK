...
export const SPAIN_CITY_SEARCH_TEXT = {
  Barcelona: "bcn catalunya catalonia el prat barcelone metro comuna",
  ...
  Sitges: "sitges barcelona coast metro comuna",
  "Hospitalet de Llobregat": "lhospitalet hospitalet barcelona metro comuna",
  Badalona: "badalona barcelona metro comuna",
  Sabadell: "sabadell barcelona metro comuna",
  Terrassa: "terrassa barcelona metro comuna",
  Mataro: "mataro mataró barcelona metro comuna",
  Castelldefels: "castelldefels barcelona metro comuna",
  Tarragona: "tgn",
  Reus: "reu",
  Lleida: "lerida lleida",
  Salou: "salou costa dorada",
  Cambrils: "cambrils costa dorada",
  Madrid: "mad capital barajas comuna",
  "Alcala de Henares": "alcala de henares alcala madrid",
  Aranjuez: "aranjuez madrid",
  "El Escorial": "el escorial san lorenzo madrid",
  Valencia: "vlc comuna comunitat",
  Torrent: "torrent valencia metro comuna",
  Sagunto: "sagunto sagunt valencia metro comuna",
  Cullera: "cullera valencia metro comuna",
  Alicante: "alc alacant comuna costa blanca",
  Malaga: "agp malaga costa del sol málaga comuna",
  ...
  Elche: "elche elx alacant alicante",
  Torrevieja: "torrevieja costa blanca",
  Gandia: "gandia gandia valencia",
  Denia: "denia denia xabia marina alta",
  Calpe: "calpe calp costa blanca",
  Peniscola: "peniscola penyiscola castellon",
  Ibiza: "ibiza eivissa",
  ...
  Castellon: "castellon castellón castelló comuna comarca",
