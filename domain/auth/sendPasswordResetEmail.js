...
export async function sendPasswordResetEmailToUser(user, request) {
  ...
  await sendEmailDirect({
    title: "rovaro — Password reset",
    message: [
      "You requested a password reset for your rovaro admin account.",
      "",
...
<html><body style="font-family:sans-serif;padding:24px;color:#1a1a1a">
  <p>You requested a password reset for your rovaro admin account.</p>
