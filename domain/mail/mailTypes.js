...
export const MAIL_TYPE = {
  ...
  CUSTOMER_BOOKING_CONFIRMED: "customer.booking_confirmed",
  SUPPLIER_BOOKING_PAID: "supplier.booking_paid",
  SUPERADMIN_BOOKING_PAYMENT_RECEIVED: "superadmin.booking_payment_received",
