...
const doc = {
  ...
  content: {
    ...
    sections: [
      ...
      {
        id: "17",
        heading: "Negativa antes del inicio del alquiler",
        body: "Si el Proveedor se niega a entregar el vehículo antes del inicio del alquiler, el Proveedor no tiene derecho a cobrar ninguna parte del Saldo restante del alquiler.\n\nRovaro examinará las circunstancias y decidirá si la Tasa de Reserva Rovaro:\n\n- se reembolsa íntegramente al Cliente; o\n- la retiene Rovaro.\n\nEn esta situación no procede un reembolso parcial de la Tasa de Reserva.\n\nRovaro normalmente reembolsará la Tasa de Reserva cuando el Proveedor no pueda facilitar el vehículo reservado o, de otro modo, no pueda cumplir la Reserva confirmada.\n\nRovaro podrá retener la Tasa de Reserva cuando la negativa derive de la conducta del Cliente, incluidos el fraude sospechado, el uso indebido de la identidad, documentos inválidos o inconsistentes, el incumplimiento de requisitos del conductor o del alquiler claramente divulgados, la actividad ilícita, o una preocupación genuina de seguridad.\n\nEl Proveedor debe indicar el motivo de la negativa y facilitar cualquier información acreditativa pertinente. El Proveedor no puede decidir, prometer ni denegar por su cuenta un reembolso de la Tasa de Reserva Rovaro.\n\nLa decisión de Rovaro se adoptará caso por caso, a partir de las pruebas disponibles, de los requisitos divulgados antes de la reserva, de la conducta de ambas partes y de la normativa aplicable. La Tasa de Reserva se reembolsará siempre cuando así lo exija la normativa aplicable.",
      },
      {
        id: "18",
