  ...
  content: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "El Cliente abona al Operador un Prepago de Reserva equivalente al 10% del precio total del alquiler en el momento de la reserva. El Operador confirma la Reserva al Cliente y al Proveedor una vez que dicho pago se ha realizado con éxito.\n\nEl 90% restante del precio total del alquiler constituye el Saldo. El Saldo lo abona el Cliente directamente al Proveedor en el momento de la entrega del vehículo, conforme a las condiciones de pago del propio Proveedor publicadas en la Plataforma.\n\nEl Prepago de Reserva cancela parcialmente la obligación del Cliente de pagar el precio del alquiler. El Proveedor debe imputar el Prepago de Reserva al precio total y no puede exigir al Cliente su pago por segunda vez.",
      },
      {
        id: "10",
        heading: "Comisión y comisión mínima",
        body: "Como contraprestación por los servicios de intermediación, reserva y pago prestados por el Operador, el Proveedor adeuda al Operador una comisión del {{settings.commissionPercent}} sobre la base de comisión de cada Reserva.\n\nEl Operador retiene su comisión del Prepago de Reserva. Cuando la comisión calculada para una Reserva resulte inferior a la comisión mínima configurada de {{settings.minimumCommissionAmount}}, se aplicará dicha comisión mínima.\n\nCuando la comisión retenida exceda del importe debido, o cuando una Reserva se cancele en circunstancias que den derecho al Proveedor a un ajuste de comisión, la regularización se practicará conforme al ciclo de liquidación mostrado en la cuenta de colaborador.",
      },
      {
        id: "11",
        heading: "Base de comisión, comisiones bancarias y resumen económico",
        body: "La base de comisión es el precio del alquiler correspondiente al vehículo y al periodo reservados. Los cargos de entrega y recogida, los extras opcionales, las mejoras de seguro y los recargos por atención fuera del horario habitual forman parte de la base de comisión únicamente cuando la Configuración de la Plataforma así lo establezca de forma expresa. En caso contrario, quedan excluidos de la base de comisión.\n\nLas comisiones de procesamiento de pagos y el tratamiento del IVA aplicable a la comisión y al Prepago de Reserva son configurables en la Configuración de la Plataforma y pueden variar en función de la situación fiscal del Proveedor y de su país de establecimiento.\n\nPara cada Reserva, la Plataforma registra un resumen económico en el que constan el precio total, el Prepago de Reserva, el Saldo, la base de comisión, la comisión aplicada, la comisión mínima aplicada en su caso, las comisiones de procesamiento de pagos y el tratamiento del IVA utilizado. Dicho resumen es visible para el Proveedor en su cuenta de colaborador y constituye el registro de referencia a efectos de liquidación.",
      },
      {
        id: "12",
        heading: "La fianza es distinta del Prepago de Reserva",
        body: "El Prepago de Reserva no es una fianza, ni un depósito en garantía por daños, ni una garantía de ningún tipo. Es un pago anticipado y parcial del precio del alquiler percibido por el Operador.\n\nToda fianza exigida por el vehículo constituye un importe distinto, fijado por el Proveedor, percibido por el Proveedor directamente del Cliente en el momento de la entrega, custodiado por el Proveedor y liberado por el Proveedor. El Operador no percibe ni custodia fianzas y carece de facultad alguna sobre su retención o devolución.\n\nEl Proveedor debe informar del importe, del medio de cobro y de las condiciones de devolución de cualquier fianza antes de que el Cliente complete la Reserva.",
      },
      {
        id: "13",
      ...
      },
      {
        ...
        body: "Si el Proveedor cancela una Reserva cuyo Prepago de Reserva ya se ha percibido, se producirán las consecuencias siguientes.\n\n- El Cliente recibirá la devolución íntegra del Prepago de Reserva y de cualquier otro importe abonado a través de la Plataforma por esa Reserva.\n- El Proveedor reembolsará al Operador los costes documentados de procesamiento de pagos, devolución y retrocesión de cargos soportados en relación con la Reserva cancelada.\n- El Proveedor abonará el cargo por servicio previsto en la Configuración de la Plataforma para la cancelación por el proveedor, actualmente {{settings.supplierCancellationServiceCharge}}.\n\nEstas consecuencias no se aplicarán cuando la cancelación derive de un acontecimiento ajeno al control razonable del Proveedor que este acredite a satisfacción razonable del Operador, ni cuando el Cliente haya aceptado la cancelación.",
      },
      {
        id: "17",
