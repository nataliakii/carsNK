...
const doc = {
  ...
  content: {
    ...
    sections: [
      ...
      {
        id: "9",
        heading: "Booking Prepayment and Balance",
        body: "The Customer pays the Operator a Booking Prepayment of 10% of the total rental price at the moment of booking. The Operator confirms the Booking to the Customer and to the Supplier once that payment has succeeded.\n\nThe remaining 90% of the total rental price is the Balance. The Balance is paid by the Customer directly to the Supplier at vehicle handover, in accordance with the Supplier own payment terms as disclosed on the Platform.\n\nThe Booking Prepayment discharges part of the Customer obligation to pay the rental price. The Supplier must credit the Booking Prepayment against the total price and must not require the Customer to pay it a second time.",
      },
      {
        id: "10",
        heading: "Commission and minimum commission",
        body: "In consideration for the intermediation, booking and payment services provided by the Operator, the Supplier owes the Operator a commission of {{settings.commissionPercent}} of the commission base for each Booking.\n\nThe Operator retains its commission from the Booking Prepayment. Where the commission calculated for a Booking is lower than the configured minimum commission of {{settings.minimumCommissionAmount}}, the minimum commission applies instead.\n\nWhere the commission retained exceeds the amount due, or where a Booking is cancelled in circumstances that entitle the Supplier to a commission adjustment, the adjustment is settled in accordance with the settlement cycle shown in the partner account.",
      },
      {
        id: "11",
        heading: "Commission base, fees and the financial snapshot",
        body: "The commission base is the rental price for the vehicle and period booked. Delivery and collection charges, optional extras, insurance upgrades and after-hours charges form part of the commission base only where the Platform Settings expressly configure them to do so. Where they are not so configured, they are excluded from the commission base.\n\nPayment processing fees and the VAT treatment applicable to the commission and to the Booking Prepayment are configurable in the Platform Settings and may differ according to the Supplier tax status and country of establishment.\n\nFor each Booking the Platform records a financial snapshot showing the total price, the Booking Prepayment, the Balance, the commission base, the commission applied, any minimum commission applied, payment processing fees and the VAT treatment used. The snapshot is visible to the Supplier in the partner account and is the reference record for settlement.",
      },
      {
        id: "12",
        heading: "Security deposit is separate from the Booking Prepayment",
        body: "The Booking Prepayment is not a security deposit, a damage deposit or a guarantee. It is an advance part-payment of the rental price received by the Operator.\n\nAny security deposit required for the vehicle is a separate amount, set by the Supplier, collected by the Supplier directly from the Customer at handover, held by the Supplier and released by the Supplier. The Operator neither collects nor holds security deposits and has no authority over their retention or release.\n\nThe Supplier must disclose the amount, the method of collection and the conditions of release of any security deposit before the Customer completes the Booking.",
      },
      {
        id: "13",
      ...
      },
      {
        ...
        body: "If the Supplier cancels a Booking for which the Booking Prepayment has been received, the following consequences apply.\n\n- The Customer receives a full refund of the Booking Prepayment and of any other amount paid through the Platform for that Booking.\n- The Supplier reimburses the Operator for documented payment processing, refund and chargeback costs incurred in connection with the cancelled Booking.\n- The Supplier pays the service charge set out in the Platform Settings for supplier cancellation, currently {{settings.supplierCancellationServiceCharge}}.\n\nThese consequences do not apply where the cancellation results from an event outside the reasonable control of the Supplier that the Supplier evidences to the reasonable satisfaction of the Operator, or where the Customer has agreed to cancel.",
      },
      {
        id: "17",
