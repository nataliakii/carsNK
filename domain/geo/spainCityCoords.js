...
export const SPAIN_CITY_COORDS = {
  ...
  "Hospitalet de Llobregat": { lat: 41.3594, lon: 2.0998 },
  Badalona: { lat: 41.4502, lon: 2.2474 },
  Sabadell: { lat: 41.5431, lon: 2.1094 },
  Terrassa: { lat: 41.561, lon: 2.0086 },
  Mataro: { lat: 41.5381, lon: 2.4445 },
  Castelldefels: { lat: 41.2802, lon: 1.9767 },
  ...
  "Alcala de Henares": { lat: 40.4818, lon: -3.3635 },
  Aranjuez: { lat: 40.0309, lon: -3.6058 },
  "El Escorial": { lat: 40.585, lon: -4.1474 },
  Valencia: { lat: 39.4699, lon: -0.3763 },
  Torrent: { lat: 39.437, lon: -0.4656 },
  Sagunto: { lat: 39.6794, lon: -0.273 },
  Cullera: { lat: 39.165, lon: -0.252 },
  ...
  Gandia: { lat: 38.9677, lon: -0.1804 },
  Denia: { lat: 38.8408, lon: 0.1057 },
  Calpe: { lat: 38.6447, lon: 0.0444 },
  Peniscola: { lat: 40.3572, lon: 0.4075 },
