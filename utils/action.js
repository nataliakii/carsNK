  ...
  try {
    ...
    const fetchOptions = {
      ...
      body: JSON.stringify({
        ...
        placeInDetail: normalizedOptions.placeInDetail,
        placeOutDetail: normalizedOptions.placeOutDetail,
        placeInLat: normalizedOptions.placeInLat,
        placeInLon: normalizedOptions.placeInLon,
        placeOutLat: normalizedOptions.placeOutLat,
        placeOutLon: normalizedOptions.placeOutLon,
        placeInLocality: normalizedOptions.placeInLocality,
        placeOutLocality: normalizedOptions.placeOutLocality,
      }),
      cache: "no-store",
    };
